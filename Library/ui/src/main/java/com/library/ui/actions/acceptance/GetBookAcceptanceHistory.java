...
@Component
public class GetBookAcceptanceHistory extends AbstractAction implements IAction {
    ...
    public void execute() {
        try{
            ...
            List<Acceptance> acceptance=libraryFacade.getAllAcceptance().stream().filter(c->c.getBook().getId().equals(bookIdInteger)).collect(Collectors.toList());
